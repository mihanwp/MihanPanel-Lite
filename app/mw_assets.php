...
class mw_assets
{
    ...
    {
        $plugin_version = \mwplite\app\mw_tools::get_plugin_version();
    ...
    public static function load_panel_js()
    {
        ...
        $version = mw_tools::get_plugin_version();
    ...
    {
        $version = \mwplite\app\mw_tools::get_plugin_version();
    ...
    {
        $mp_bg_image = \mwplite\app\mw_options::get_login_bg();
        $mp_logo = \mwplite\app\mw_options::get_logo();
        $plugin_version = \mwplite\app\mw_tools::get_plugin_version();
    ...
    static function load_front_assets()
    {
        ...
        if (isset($post->post_content) && is_singular(array('post', 'page')) && has_shortcode($post->post_content, 'mihanpanel')) {
            ...
            \mwplite\app\mw_assets::load_panel_js();
        }
