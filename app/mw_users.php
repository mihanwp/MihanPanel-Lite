...
class mw_users
{
    ...
    public static function get_new_activation_link($user_id)
    {
        ...
        $url = $activation_code ? mw_options::get_login_url('?activation_code=' . $activation_code) : false;
        return $url;
    }
    ...
    {
        $activation_type = mw_options::get_account_activation_type();
        switch ($activation_type)
        {
            case mw_options::LINK_ACTIVATION_MODE:
                mw_email::send_activation_link($user_id);
                break;
            case mw_options::MANUAL_ACTIVATION_MODE:
                mw_email::manual_mode_email_process($user_id);
                mw_users::create_activation_link($user_id);
                break;
        }
    }
    ...
    public static function activate_btn_in_user_profile($user){
        ...
        $view = mw_views::get('admin.admin-profile.account-status');
        include $view;
    }
