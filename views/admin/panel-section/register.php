<div>
    ...
    <form class="mp_options_panel" method="post" action="options.php">
        ...
        <div class="mp_option_single">
            ...
            <input style="text-align:left;direction:ltr" id="mp_send_emails_from" type="text" name="mp_send_emails_from" placeholder="info@siteshoma.com" value="<?php echo get_option('mp_send_emails_from'); ?>" />
