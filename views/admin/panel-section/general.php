    ...
    <form class="mp_options_panel" method="post" action="options.php">
        ...
        <div class="mp_options_section">
            ...
            <div class="mp_option_single">
                ...
                <span class="mpproversion"><a target="blank" href="<?php echo $pro_version_link; ?>"><?php _e("Pro Version", "mihanpanel");?></a></span>
                <p class="description"><?php _e("Login and Register form theme", "mihanpanel"); ?></p>
            </div>
            <div class="mp_option_single">
                <label><?php _e("Login Button Color", "mihanpanel");?></label>
                <input type="text" name="login_button_color" id='login_button_color' value="<?php echo get_option('login_button_color'); ?>" class="my-color-field" />
            ...
            <div class="mp_option_single">
                ...
                <input style="text-align:left;direction:ltr" id="mp_logo_image" type="text" name="mp_logo_image" value="<?php echo get_option('mp_logo_image'); ?>" />
                <input id="mp_upload_image_button" type="button" class="button-primary" value="<?php _e("Upload Image", "mihanpanel"); ?>" />
            ...
            <div class="mp_option_single">
                ...
                <input style="text-align:left;direction:ltr" id="mp_bg_image" type="text" name="mp_bg_image" value="<?php echo get_option('mp_bg_image'); ?>" />
                <input id="mp_upload_bg_image_button" type="button" class="button-primary" value="<?php _e("Upload Image", "mihanpanel"); ?>" />
            </div>
            <div class="mp_option_single">
