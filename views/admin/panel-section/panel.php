<div>
    ...
    <form class="mp_options_panel" method="post" action="options.php">
        ...
        <div class="mp_option_single">
            ...
            <select name="mp_panelslug" class="mw_select2" id="mp_panelslug">
                <?php if($all_pages->have_posts()):
                    ...
                    ?>
                    <option <?php selected($slug, $current_slug_value); ?> value="<?php echo $slug; ?>"><?php echo get_the_title(); ?></option>
                    <?php endwhile; ?>
                <?php else: ?>
        ...
        <div class="mp_option_single">
            ...
            <input style="text-align:left;direction:ltr" id="mp_offer_code" type="text" name="mp_offer_code" value="<?php echo get_option('mp_offer_code'); ?>" />
        ...
        <div class="mp_option_single">
            ...
            <input id="mp_offer_perc" type="text" name="mp_offer_perc" value="<?php echo get_option('mp_offer_perc'); ?>" />
