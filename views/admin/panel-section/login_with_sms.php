    ...
    <form class="mp_options_panel" method="post" action="options.php">
        ...
        <div class="mp_option_single">
            <p>
                ...
                <span class="mpproversion"><a target="blank" href="<?php echo $pro_version_link; ?>"><?php _e("Pro Version", "mihanpanel");?></a></span>            </p>
            <p>
        ...
        <div class="mp_option_single">
            ...
            <span class="mpproversion"><a target="blank" href="<?php echo $pro_version_link; ?>"><?php _e("Pro Version", "mihanpanel");?></a></span>            <p><?php _e("You can use this:", "mihanpanel"); ?></p>
            <p>
