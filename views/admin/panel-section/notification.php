...
<form class="mp_options_panel" method="post" action="options.php">
    ...
    <div>
        <div class="mp_option_single">
            <label><?php esc_html_e("Notification 1", "mihanpanel"); ?></label>
            ...
            <p class="description"><?php esc_html_e("Create a notification to show to your users in their dashboard.", "mihanpanel"); ?></p>
        </div>
        <div class="mp_option_single">
            <label><?php esc_html_e("Notification 2", "mihanpanel"); ?></label>
        ...
        <div class="mp_option_single">
            <label><?php esc_html_e("Notification 3", "mihanpanel"); ?></label>
        ...
        <div class="mp_option_single">
            <label><?php esc_html_e("Notification 4", "mihanpanel"); ?></label>
        ...
        <div class="mp_option_single">
            <label><?php esc_html_e("Notification 5", "mihanpanel"); ?></label>
        ...
        <div class="mp_option_single">
            <label><?php esc_html_e("Notification 6", "mihanpanel"); ?></label>
        ...
        <div class="mp_option_single">
            <label><?php esc_html_e("Notification 7", "mihanpanel"); ?></label>
        ...
        <div class="mp_option_single">
            <label><?php esc_html_e("Notification 8", "mihanpanel"); ?></label>
